...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let (:my_sponsored_post) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 20)}
  ...
  describe "POST create" do
    ...
    it "increases the number of SponsoredPost by 1" do
      expect{post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 20}}.to change(SponsoredPost, :count).by(1)
    end

    it "assigns new sponsored_post @sponsored_post" do
      post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 20}
  ...
  describe "PUT update" do
    it "updates sponsored post with expected attributes" do
       ...
       put :update, topic_id: my_topic.id, id: my_sponsored_post.id, sponsored_post: {title: new_title, body: new_body, price: 20}
       ...
       expect(updated_sponsored_post.price).to eq(20)
    end
